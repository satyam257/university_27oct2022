    ...
    <div class="mx-3">
        <div class="form-panel">
            <form class="cmxform form-horizontal style-form" method="post" action="{{route('admin.result_release.store')}}">
                {{csrf_field()}}
                <p>{{__('text.phrase_4')}}</p>
                <div class="form-group @error('year_id') has-error @enderror">
                    <label for="year_id" class="control-label col-lg-2 text-capitalize">{{__('text.word_year')}}</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group @error('start_date') has-error @enderror">
                    <label for="start_date" class="control-label col-lg-2">{{__('text.start_date')}}</label>
                    <div class="col-lg-10">
